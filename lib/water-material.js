...
THREE.ShaderLib['water'] = {
  ...
  fragmentShader: [
    ...
    //ERIC LEVIN: (sin(time * 100.0) * 10.0) to make mirror get trrriiipy
    ' vec2 distortion = surfaceNormal.xz * ( 0.001 + 1.0 / distance ) * (sin(time * 100.0) * 10.0 + distortionScale);',
    ...
    ' vec3 albedo = mix( sunColor * diffuseLight * 0.3 + scatter, ( vec3( 0.4, 0.5, 0.5 ) + reflectionSample * 0.9 + reflectionSample * specularLight ), reflectance );',
