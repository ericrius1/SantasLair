...
ShaderParticleGroup.prototype = {
    ...
    _flagUpdate: function() {
        ...
        that.attributes.customColor.needsUpdate = true;
     ...
     * @return {this}
     */
    _triggerSingleEmitter: function( pos, color ) {
        var that = this,
     ...
     * @return {this}
     */
    triggerPoolEmitter: function( numEmitters, position, color ) {
        var that = this;

        if( typeof numEmitters === 'number' && numEmitters > 1) {
            for( var i = 0; i < numEmitters; ++i ) {
                that._triggerSingleEmitter( position, color );
            }
        }
        else {
            that._triggerSingleEmitter( position, color );
