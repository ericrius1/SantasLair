(function() {
  ...
  FW.Tree = Tree = (function() {
    ...
    Tree.prototype.generateBuilding = function() {
    ...
    Tree.prototype.activate = function() {
      ...
      for (i = _i = 1; _i <= 100; i = ++_i) {
        _results.push(this.cityGroup.triggerPoolEmitter(1, new THREE.Vector3(rnd(-100000, 100000), rnd(-300, -10), rnd(-80000, 100000))));
      }
      return _results;
    };
